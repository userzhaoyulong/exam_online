	...
	<div id="hd">
    	<div class="hd-wrap ue-clear">
            ...
            <div class="login-info ue-clear">
                <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:;" class="user-name">${sessionScope.admin.username }</a></div>
                ...
                <ul class="nav">
                    ...
                    <li class="konwledge">
						...
						<ul class="subnav">
                            ...
                            <li><a href="#" onclick="formSubmit('${ctx}/admin/toInfoDeal','mframe');this.blur();">身份审核</a></li>
                        </ul>
					</li>
                    <li class="agency">
